...
import com.sample.thehealthscale.BuildConfig;
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mGradientColors = typedArray.getColor(R.styleable.CircleProgressBar_arcColors, Color.WHITE);
        ...
        if (gradientArcColors != 0) {
            try {
                ...
                Log.d("color", ""+gradientColors.length);
    ...
    private void initPaint() {
        ...
        mArcPaint.setColor(mGradientColors);
        //Log.d("style",""+R.styleable.CircleProgressBar_arcColors);
    ...
    public void setMaxValue(float maxValue) {
        mMaxValue = maxValue;
        startAnimator(mPercent, maxValue, 1000L);
    }
...
//    }
     ...
     */
    public void reset() {
        startAnimator(mPercent, mMaxValue, 1000L);
    }
